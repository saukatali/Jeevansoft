                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.SEO_PAGES.SEO_PAGE_TITLE') }}
                                    </a>
                                        ...
                                        <div>
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <input type="text" name="page_name" class="form-control" value="{{ isset($searchVariable['page_name']) ? $searchVariable['page_name'] : '' }}" placeholder="Page Name">
                                                </div>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'page_title' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'page_title' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'page_title',
                                                    'order' => ($sortBy == 'page_title' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}">Page Title</a>
                                                    </th>

                                                    <th class="{{(($sortBy == 'page_id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'page_id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'page_id',
                                                    'order' => ($sortBy == 'page_id' && $order == 'desc') ? 'asc' : 'desc',   
