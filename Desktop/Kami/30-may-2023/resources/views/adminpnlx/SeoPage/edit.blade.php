            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit {{ Config('constants.SEO_PAGES.SEO_PAGE_TITLE') }} </h5>
                    <!--end::Page Title-->
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_id"
                                        ...
                                        value="{{$modelDetails->page_id ??  old('page_id') }}">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_name"
                                        ...
                                        value="{{ $modelDetails->page_name ?? old('page_name') }}">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meta_title"
                                        ...
                                        value="{{$modelDetails->meta_title ??  old('meta_title') }}">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="meta_description" id="meta_description"
                                        class="form-control form-control-solid form-control-lg" placeholder="Meta Description">{{ $modelDetails->meta_description ?? old('meta_description') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="meta_keywords" id="meta_keywords" class="form-control form-control-solid form-control-lg"
                                        placeholder="Meta Keywords">{{ $modelDetails->meta_keywords ?? old('meta_keywords') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="twitter_card" id="twitter_card" class="form-control form-control-solid form-control-lg"
                                        placeholder="Twitter Card">{{ $modelDetails->twitter_card ?? old('twitter_card') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="twitter_site" id="twitter_site" class="form-control form-control-solid form-control-lg"
                                        placeholder="Twitter Site">{{ $modelDetails->twitter_site ?? old('twitter_site') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="og_url" id="og_url" class="form-control form-control-solid form-control-lg"
                                        placeholder="Og Url">{{ $modelDetails->og_url ?? old('og_url') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="og_type" id="og_type" class="form-control form-control-solid form-control-lg"
                                        placeholder="Og Type">{{ $modelDetails->og_type ?? old('og_type') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="og_title" id="og_title" class="form-control form-control-solid form-control-lg"
                                        placeholder="Og Title">{{$modelDetails->og_title ?? old('og_title') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="og_description" id="og_description"
                                        class="form-control form-control-solid form-control-lg" placeholder="Og Description">{{ $modelDetails->og_description ?? old('og_description') }}</textarea>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="meta_chronicles" id="meta_chronicles"
                                        class="form-control form-control-solid form-control-lg" placeholder="Meta Chronicles">{{ $modelDetails->meta_chronicles ?? old('meta_chronicles') }}</textarea>
