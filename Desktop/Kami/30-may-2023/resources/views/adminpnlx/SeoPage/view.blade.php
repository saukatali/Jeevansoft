						...
						<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x"
							...
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab"
									...
									<span class="nav-text">
									{{ Config('constants.SEO_PAGES.SEO_PAGE_TITLE') }} Details
									</span>
								</a>
							</li>
						</ul>
					  ...
					  @if(!empty($modelDetails->image))
						<div class="form-group row my-2">
								...
								<div class="col-8">
									...
									href="{{ config('constants.SEO_PAGE_IMAGE_ROOT_URL').$modelDetails->image }}">
										<img height="70" width="100" src="{{ config('constants.SEO_PAGE_IMAGE_ROOT_URL').$modelDetails->image }}">
									</a>
								</span>  
							</div>
						</div>
						@endif 
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Page Id:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->page_name ?? '' }}
									</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->meta_keywords ?? '' }}
									</span>
								</div>
							</div>

							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Twitter Card:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->twitter_card ?? '' }}
									</span>
								</div>
							</div>
							
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Twitter Site:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->twitter_site ?? '' }}
									</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Og Url:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->og_url ?? '' }}
									</span>
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Og Type:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->og_type ?? '' }}
									</span>
								</div>
							</div>

							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Og Title:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->og_title ?? '' }}
									</span>
								</div>
							</div>
