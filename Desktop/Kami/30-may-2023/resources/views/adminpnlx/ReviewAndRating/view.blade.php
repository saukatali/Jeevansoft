		...
		<div
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					View  {{ Config('constants.REVIEW_RATINGS.REVIEW_RATING_TITLE') }}
				   </h5>
						...
						<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x"
							...
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab"
									...
									<span class="nav-text">
									 {{ Config('constants.REVIEW_RATINGS.REVIEW_RATING_TITLE') }} Details
									</span>
								</a>
							</li>
						</ul>
					...
					<div class="tab-content px-10">
						...
						<div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Reviewed By:</label>
								<div class="col-8">
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
									@if(!empty($modelDetails->rating))
									@for ($j = 1; $j <= 5; $j++)
									@if ($j <= $modelDetails->rating)
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label"> Review:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
									{{ $modelDetails->review ?? '' }}
									</span>
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Reviewed On:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
