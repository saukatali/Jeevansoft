                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.CATEGORY.CATEGORY_TITLE') }}
                                    </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            ...
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.CATEGORY_IMAGE_ROOT_URL').$result->image }}">
                                                                <img height="50" width="70" src="{{ config('constants.CATEGORY_IMAGE_ROOT_URL').$result->image }}">
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href='{{ route("SubCategory.index", base64_encode($result->id)) }}' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Sub Category">
                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/><circle fill="#000000" cx="12" cy="5" r="2"/> <circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="12" cy="19" r="2"/>
                                                                </g>
                                                            </svg>
                                                        </a>
                                                    </td>
