        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{ Config('constants.DESIGNATIONS.DESIGNATION_TITLE') }}
                    </h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('Department.index') }}" class="text-muted">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create", $enmodelid) }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }}  {{ Config('constants.DESIGNATIONS.DESIGNATION_TITLE') }} 
                                    </a>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    $query_string))}}"> Designation Name</a>
                                                    </th>

                                                   
                                                    <th class="{{(($sortBy == 'department_id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'department_id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( $enmodelid , 'sortBy' => 'department_id',
                                                    'order' => ($sortBy == 'department_id' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Department Name </a>
                                                    </th>
