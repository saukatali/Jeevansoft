                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }}  {{ Config('constants.BLOGS.BLOG_TITLE') }}
                                    </a>

                                     <a href='{{ route("$modelName.edit_setting_title") }}' class="btn btn-primary mx-2">
                                        Setting Blog
                                    </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            ...
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.BLOG_IMAGE_ROOT_URL').$result->image }}">
                                                                <img height="50" width="70" src="{{ config('constants.BLOG_IMAGE_ROOT_URL').$result->image }}">
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php $file = $result->attachment;
                                                        $extension = substr($file, strpos($file, '.'))
                                                         ?>
                                                         @if($extension == '.docx' || $extension == '.doc')
                                                         <div class="text-dark-75 mb-1 font-size-lg">
                                                                <a  href="{{ Config('constants.BLOG_IMAGE_ROOT_URL').$result->attachment }}" download="download">
