                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.COLORS.COLOR_TITLE') }}
                                    </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            ...
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.COLOR_IMAGE_ROOT_URL').$result->image }}">
                                                                <img height="50" width="50" src="{{ config('constants.COLOR_IMAGE_ROOT_URL').$result->image }}">
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </td>
