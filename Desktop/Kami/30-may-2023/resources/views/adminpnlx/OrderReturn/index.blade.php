        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{ Config('constants.ORDER_CANCELS.ORDER_CANCELS_TITLE') }}
                    </h5>
                    <!--end::Page Title-->
                                            ...
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'user_name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'user_name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'user_name',
                                                    'order' => ($sortBy == 'user_name' && $order == 'desc') ? 'asc' : 'desc',  $query_string))}}">
                                                     User Name </a>
                                                    </th>
