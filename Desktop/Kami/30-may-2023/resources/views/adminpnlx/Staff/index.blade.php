                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.staffExport") }}' class="btn btn-success mx-2">
                                        Export {{ Config('constants.STAFFS.STAFF_TITLE') }}
                                    </a>

                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.STAFFS.STAFF_TITLE') }}
                                    </a>
