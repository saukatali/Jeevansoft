...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    {{ Config('constants.SUB_CATEGORY.SUB_CATEGORY_TITLE') }}
                    </h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('Category.index') }}" class="text-muted">
                            {{ Config('constants.CATEGORY.CATEGORYS_TITLE') }}
                            </a>
                        </li>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container ">
            ...
            <form action='{{ route("$modelName.index", $enmodelid) }}' method="get" class="kt-form kt-form--fit mb-0" autocomplete="off">
                <div class="row">
                    <div class="col-12">
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create", $enmodelid) }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.SUB_CATEGORY.SUB_CATEGORY_TITLE') }}
                                    </a>
                                        ...
                                        <div>
                                            ...
                                            <div class="row mt-8">
                                                <div class="col-lg-12">
                                                    ...
                                                    <a href='{{ route("$modelName.index", $enmodelid) }}' class="btn btn-secondary btn-secondary--icon">
                                                        <span>
                                            ...
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( $enmodelid , 'sortBy' => 'name',
                                                    ...
                                                    <th class="{{(($sortBy == 'description' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'description' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array($enmodelid , 'sortBy' => 'description',
                                                   ...
                                                   <th class="{{(($sortBy == 'created_at' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'created_at' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( $enmodelid , 'sortBy' => 'created_at',
                                                    ...
                                                    <th class="{{(($sortBy == 'is_active' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'is_active' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( $enmodelid , 'sortBy' => 'is_active',
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            ...
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.SUB_CATEGORY_IMAGE_ROOT_URL').$result->image }}">
                                                                <img height="50" width="70" src="{{ config('constants.SUB_CATEGORY_IMAGE_ROOT_URL').$result->image }}">
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            {{ strip_tags(Str::limit($result->description , 100)) ?? '' }}
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href='{{ route("$modelName.edit", array(base64_encode($result->id),$enmodelid) ) }}' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Edit">
                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
