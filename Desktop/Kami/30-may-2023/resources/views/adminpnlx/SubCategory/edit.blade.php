...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit {{ Config('constants.SUB_CATEGORY.SUB_CATEGORY_TITLE') }} </h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route($modelName.'.index', $enmodelid)}}" class="text-muted">
    ...
    <div class="d-flex flex-column-fluid">
        <!--begin::Container-->
        <div class=" container ">
            <form method="post" action="{{route($modelName.'.update', array( base64_encode($modelDetails->id) , $enmodelid) )}}"
                class="mws-form" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="card card-custom gutter-b">
                    <div class="card-header card-header-tabs-line">
                        <h3 class="card-title font-weight-bolder text-dark">
                        {{ Config('constants.SUB_CATEGORY.SUB_CATEGORY_TITLE') }} Information
                        </h3>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <div class="banner-image">
                                        <img height="70" width="100" src="{{ config('constants.SUB_CATEGORY_IMAGE_ROOT_URL').$modelDetails->image }}" />
                            ...
                            <div class="col-xl-6">
                             ...
                             <div class="col-xl-6">
                                <div class="form-group">
                                    <label for="category_id">Category Name</label> <span class="text-danger"> * </span>
                                    <input type="text" name="category_id"
                                        class="form-control form-control-solid form-control-lg" placeholder="Category Name"
                                        value="{{ $modelDetails->name ?? old('category_id') }}">
                                        <select name="category_id" class="form-control form-control-solid form-control-lg">
