            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        {{ Config('constants.BANNERS.BANNERS_TITLE') }}
                    </h5>
                    <!--end::Page Title-->
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.BANNERS.BANNER_TITLE') }}
                                    </a>
                                    ...
                                    <div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
                                        <div>
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    <label> Title </label>
                                                    <input type="text" name="title" class="form-control" value="{{ isset($searchVariable['title']) ? $searchVariable['title'] : '' }}" placeholder="Title">
                                                </div>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'sub_title' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'sub_title' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'sub_title',
                                                    'order' => ($sortBy == 'sub_title' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Sub Title</a>
                                                    </th>

                                                    <th class="{{(($sortBy == 'description' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'description' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'description',
                                            ...
                                            <tbody id="powerwidgets">
                                                ...
                                                <tr class="items-inner-sort" data-id="{{$result->id}}">
                                                    <td>
                                                        <img src="{{asset('public/frontend/img/')}}/Menu.svg" alt="" width="20">
                                                    </td>

                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            @if(!empty($result->image ))
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.BANNER_IMAGE_ROOT_URL').$result->image }}">
                                                                <img height="50" width="70" src="{{ config('constants.BANNER_IMAGE_ROOT_URL').$result->image }}">
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </td>
...
<script>
    new Sortable(powerwidgets, {
        ...
        onEnd: function(evt) {
            var counter = 1;
            var requestData = [];
            $(".items-inner-sort").each(function() {
                requestData.push({
            ...
            $.ajax({
                url: '{{ URL("adminpnlx/update-banner-order") }}',
                type: 'POST',
                headers: {
