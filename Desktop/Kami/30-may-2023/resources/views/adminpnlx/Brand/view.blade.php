				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul
						...
						<li class="breadcrumb-item">
							...
							{{ Config('constants.BRANDS.BRAND_TITLE') }}
							</a>
						</li>
					</ul>
					<!--end::Breadcrumb-->
						...
						<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x"
							...
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab"
									...
									<span class="nav-text">
									{{ Config('constants.BRANDS.BRAND_TITLE') }} Details
									</span>
								</a>
							</li>
						</ul>
						...
						<div class="form-group row my-2">
								...
								<div class="col-8">
									...
									<a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.USER_IMAGE_ROOT_URL').$modelDetails->image }}">
                                        <img height="100" width="100" src="{{ config('constants.BRAND_IMAGE_ROOT_URL').$modelDetails->image }}">
                                    </a> 
								</span>  
							</div>
						</div>
