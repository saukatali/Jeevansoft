                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.COUPONS.COUPON_TITLE') }}
                                    </a>
                                        ...
                                        <div>
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <input type="text" name="offer_code" class="form-control" value="{{ isset($searchVariable['offer_code']) ? $searchVariable['offer_code'] : ''  }}" placeholder="Offer Code">
                                                </div>
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    <label>  Count </label>
                                                    <input type="number" name="count" class="form-control" value="{{ isset($searchVariable['count']) ? $searchVariable['count'] : ''  }}" placeholder="Count">
                                                </div>
                                            </div>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'offer_code' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'offer_code' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'offer_code',
                                                    'order' => ($sortBy == 'offer_code' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Offer Code</a>
                                                    </th>

                                                    <th class="{{(($sortBy == 'start_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'start_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'start_date',
                                                    'order' => ($sortBy == 'start_date' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Count </a>
                                                    </th>

                                                    <th class="{{(($sortBy == 'end_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'end_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'end_date',
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="label label-lg label-light-success label-inline">Percentage</span>
                                                        @else
                                                        <span class="label label-lg label-light-info label-inline">Fixed</span>
                                                        @endif
