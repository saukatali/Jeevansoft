						...
						<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x"
							...
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab"
									...
									<span class="nav-text">
									{{ Config('constants.COUPONS.COUPON_TITLE') }} Details
									</span>
								</a>
							</li>
						</ul>
					  ...
					  @if(!empty($modelDetails->image))
						<div class="form-group row my-2">
								...
								<div class="col-8">
									...
									href="{{ config('constants.COUPON_IMAGE_ROOT_URL').$modelDetails->image }}">
						...
						@endif 
							...
							<div class="form-group row my-2">
								<label class="col-4 col-form-label"> Offer code:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ $modelDetails->offer_code ?? '' }}
									</span>
								</div>
							</div>

							<div class="form-group row my-2">
								<label class="col-4 col-form-label"> Count:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
									{{ $modelDetails->count ?? '' }}
									</span>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
									{{ $modelDetails->start_date ?? '' }}
									</span>
								</div>
							</div>

							<div class="form-group row my-2">
								<label class="col-4 col-form-label"> Edt date:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
									{{ $modelDetails->end_date ?? '' }}
									</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
									@if ($modelDetails->type == 'percentage')
