...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						Edit  {{ Config('constants.CMS_PAGES.CMS_PAGE_TITLE') }} </h5>
					<!--end::Page Title-->
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			<form method="post" action="{{route($modelName.'.update', base64_encode($modelDetails->id))}}" class="mws-form" enctype="multipart/form-data" autocomplete="off">
				@csrf
				<div class="card card-custom gutter-b">
					<div class="card-header card-header-tabs-line">
						<h3 class="card-title font-weight-bolder text-dark"> 
						 {{ Config('constants.CMS_PAGES.CMS_PAGE_TITLE') }} Information
						</h3>
					</div>
						...
						<div class="row">
							<div class="col-xl-6">
								<div class="form-group">
									...
									<input name="page_name" class="form-control form-control-solid form-control-lg @error('page_name') is-invalid @enderror" value="{{ $modelDetails->page_name ?? old('page_name')}}" />
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group">
                                                    ...
                                                    value=" {{ isset($multiLanguage[$language->id]['page_title'])? $multiLanguage[$language->id]['page_title'] : old('data.'.$language->id.'.page_title') }}"/>
											...
											<div class="col-xl-12">
												<div class="form-group">
													...
													<textarea name="data[{{$language->id}}][description]" id="description_{{$language->id}}" class="form-control form-control-solid form-control-lg @error('description') is-invalid @enderror" rows="5">{{isset($multiLanguage[$language->id]['description'])?$multiLanguage[$language->id]['description']:''}}</textarea>
