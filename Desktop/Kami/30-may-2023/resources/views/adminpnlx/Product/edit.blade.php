            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit {{ Config('constants.PRODUCTS.PRODUCT_TITLE') }} </h5>
                    <!--end::Page Title-->
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header card-header-tabs-line">
                        <h3 class="card-title font-weight-bolder text-dark">
                            {{ Config('constants.PRODUCTS.PRODUCT_TITLE') }} Information
                        </h3>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price"
                                        class="form-control form-control-solid form-control-lg" placeholder="Price"
                                        value="{{ $modelDetails->price ?? old('price') }}">
                                    @if ($errors->has('price'))
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    <label for="number">Discount</label> <span class="text-danger"> </span>
                                    <input type="number" name="discount"
                                        class="form-control form-control-solid form-control-lg" placeholder="Discount"
                                        value="{{ $modelDetails->discount ?? old('discount') }}">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity"
                                        class="form-control form-control-solid form-control-lg" placeholder="Quantity"
                                        value="{{ $modelDetails->quantity ?? old('quantity') }}">
                                    @if ($errors->has('quantity'))
