                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.import") }}' class="btn btn-primary mx-2">
                                        Import {{ Config('constants.PRODUCTS.PRODUCT_TITLE') }}
                                    </a>

                                    <a href='{{ route("$modelName.create") }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ Config('constants.PRODUCTS.PRODUCT_TITLE') }}
                                    </a>
                                    ...
                                    <div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
                                        <div>
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    <label> Price </label>
                                                    <input type="text" name="price" class="form-control" value="{{ isset($searchVariable['price']) ? $searchVariable['price'] : ''  }}" placeholder="Price">
                                            ...
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'price' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'price' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'price',
                                                    ...
                                                    <th class="{{(($sortBy == 'discount' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'discount' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'discount',
                                                    'order' => ($sortBy == 'discount' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Discount </a>
                                                    </th>

                                                    <th class="{{(($sortBy == 'quantity' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'quantity' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'quantity',
                                                    'order' => ($sortBy == 'quantity' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Quantity </a>
                                                    </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            ...
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ config('constants.PRODUCT_IMAGE_ROOT_URL').$result->image }}">
                                                                <img height="50" width="70" src="{{ config('constants.PRODUCT_IMAGE_ROOT_URL').$result->image }}">
                                                            </a>
                                                            @endif
                                                        </div>
                                                    </td>
