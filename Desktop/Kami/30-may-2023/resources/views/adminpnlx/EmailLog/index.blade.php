...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
			<form action="{{route($modelName.'.index')}}" method="get" class="kt-form kt-form--fit mb-0 mws-form">
											...
											<thead>
												<tr class="text-uppercase">
													<th class="{{(($sortBy == 'email_to' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'email_to' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
														<a href="{{route($modelName.'.index',array(	'sortBy' => 'email_to',
													...
													<th class="{{(($sortBy == 'email_from' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'email_from' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
														<a href="{{route($modelName.'.index',array(	'sortBy' => 'email_from',
													...
													<th class="{{(($sortBy == 'subject' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'subject' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
														<a href="{{route($modelName.'.index',array(	'sortBy' => 'subject',
...
<script type="text/javascript">
	...
	// 	$.ajax({
	// 		url: '<?php echo URL()->to('adminpnlx/email-logs/email-details') ?>/' + id,
	// 		type: "POST",
	// 		headers: {
	...
	function getPopupClient(id) {
		$.ajax({
			url: '{{route('EmailLog.emailDetail')}}',
			type: "POST",
			headers: {
				'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
			},
