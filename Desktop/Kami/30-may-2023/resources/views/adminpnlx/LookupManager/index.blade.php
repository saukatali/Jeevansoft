...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container ">
            ...
            <form action='{{ route("$modelName.index", $type) }}' method="get" class="kt-form kt-form--fit mb-0" autocomplete="off">
                <div class="row">
                    <div class="col-12">
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$modelName.create", $type) }}' class="btn btn-primary mx-2">
                                        {{ trans('Add New ') }} {{ ucfirst($type)}}
                                    </a>
                                        ...
                                        <div>
                                            ...
                                            <div class="row mt-8">
                                                <div class="col-lg-12">
                                                    ...
                                                    <a href='{{ route("$modelName.index", $type) }}' class="btn btn-secondary btn-secondary--icon">
                                                        <span>
                                            ...
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'code' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'code' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'code',
                                                    'order' => ($sortBy == 'code' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Code</a>
                                                    </th>

                                                    <th class="{{(($sortBy == 'lookup_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'lookup_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route($modelName.'.index',array( 'sortBy' => 'lookup_type',
                                                    'order' => ($sortBy == 'lookup_type' && $order == 'desc') ? 'asc' : 'desc',   
                                                    $query_string))}}"> Lookup Type</a>
                                                    </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href='{{ route("$modelName.edit",array($type,base64_encode($result->id))) }}' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Edit">
