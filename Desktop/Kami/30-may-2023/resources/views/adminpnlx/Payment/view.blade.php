		...
		<div
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					View {{ Config('constants.PAYMENTS.PAYMENT_TITLE') }}
				   </h5>
					...
					<ul
						...
						<li class="breadcrumb-item">
							...
							{{ Config('constants.PAYMENTS.PAYMENT_TITLE') }}
							</a>
						</li>
					</ul>
					<!--end::Breadcrumb-->
						...
						<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x"
							...
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab"
									...
									<span class="nav-text">
									{{ Config('constants.PAYMENTS.PAYMENT_TITLE') }} Details
									</span>
								</a>
							</li>
						</ul>
						...
						<div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
							...
							<label class="col-4 col-form-label"> Image:</label>
								<div class="col-8">
									...
									<img height="100" width="100" src="{{ config('constants.USER_IMAGE_ROOT_URL').$modelDetails->image }}" />  
								</span>  
							</div>
						</div>
						@endif 
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ isset($modelDetails->first_name) ? $modelDetails->first_name :'' }}
									</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ isset($modelDetails->last_name) ? $modelDetails->last_name : '' }}
									</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">
										{{ isset($modelDetails->description) ? $modelDetails->description:'' }}
									</span>
								</div>
							</div>
