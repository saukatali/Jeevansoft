            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="{{Config('constants.CATEGORY_IMAGE_ROOT_URL').$category->image}}" alt="">
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel">
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{Config('constants.PRODUCT_IMAGE_ROOT_URL').$product->image}}" alt="">
                                ...
                                <ul>
                                    <li class="w-icon active">
                                        <a href="{{route('Jeevan.addToCart', base64_encode($product->id) )}}"><i class="icon_bag_alt"></i></a></li>
